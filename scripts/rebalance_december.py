...
prior_path = root / "portfolio_2025-11-30.json"
daily_path = (
    root / "december/20260921T155538800531Z/daily_index.csv"
)
probe_path = (
    root / "binance/20260921T155749305169Z/summary.csv"
)
checks_path = (
    root / "binance/20260921T155749305169Z/"
    "archive_checks_20260921T155834121158Z.json"
)
ranking_path = root / "2025-12-30/cmc.json"
destination = root / "portfolio_2025-12-31.json"

cutoff_utc = "2025-12-31T13:00:00+00:00"
date = "2025-12-31"
tolerance = Decimal("1e-18")

assets = [
    "BTC", "ETH", "BNB", "XRP", "SOL",
    "TRX", "ADA", "BCH", "LINK", "ZEC",
]
...
if prior["cutoff_utc"] != "2025-11-30T13:00:00+00:00":
...
for asset in sorted(set(quantities) | set(assets)):
    ...
    archive = ensure_monthly_archive(
        asset + "USDT", 2025, 12, root / "archives"
    )
    archived_price = monthly_open_prices(archive, 2025, 12)[date]
...
report = {
    ...
    "cutoff_local": "2025-12-31T07:00:00-06:00",
    ...
    "assumptions": [
        "User accepted provisional exclusion of HYPE for this cutoff: "
        "invalid symbol from current API and HTTP 404 daily archive "
        "do not conclusively prove historical absence.",
        "LEO and XMR remain unresolved but do not affect the selected ten.",
...
print("Composición: entra ZEC, sale XLM; diez posiciones al 10%.")
